...
|[ssd_inception_v2_traffic_light](ssd_inception_v2_traffic_light/README.md) |Single Shot Detector with inception v2 that was trained on 4 different labels on traffic light (green, yellow, red, and back of traffic light).  |
