...
// graph file name - assume we are running in this directory: ncsdk/examples/caffe/AlexNet/cpp
#define GRAPH_FILE_NAME "../graph"

// image file name - assume we are running in this directory: ncsdk/examples/caffe/AlexNet/cpp
#define IMAGE_FILE_NAME "../../../data/images/nps_electric_guitar.png"


// AlexNet image dimensions, network mean values for each channel in BGR order.
...
int main(int argc, char** argv)
{
    ...
    retCode = ncGraphCreate("AlexNet Graph", &graphHandlePtr);
    if (retCode != NC_OK)
