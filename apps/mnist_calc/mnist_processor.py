...
class MnistProcessor:
    ...
    def get_box_probability_threshold(self):
        """Get the current probability threshold for this instance. It will be between 0.0 and 1.0.

        This is the minimum allowable probability for results. The default is 0.0.

        :return: the probability threshold currently in place for this instance

        """
        return self._probability_threshold

    def set_box_probability_threshold(self, value):
        """Set the probability threshold for this instance. This must be between 0.0 and 1.0.

        This is the minimum allowable probability for results. The default is 0.0.

        :param value: the new box probability threshold value, which must be between 0.0 and 1.0
        :return: None
