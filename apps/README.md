...
|[realsense_segmentation](realsense_segmentation/README.md) | C++<br>Semantic Segmentation adas 0001<br>Colorize 20 different classes of objects (including people and cars) and uses the Intel Realsense camera to detect the distance to that object. | TBD)|
