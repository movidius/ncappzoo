...
// graph file name - assume we are running in this directory: ncsdk/examples/caffe/SqueezeNet/cpp
#define GRAPH_FILE_NAME "../graph"

// image file name - assume we are running in this directory: ncsdk/examples/caffe/SqueezeNet/cpp
#define IMAGE_FILE_NAME "../../../data/images/nps_electric_guitar.png"


// SqueezeNet image dimensions, network mean values for each channel in BGR order.
...
int main(int argc, char** argv)
{
    ...
    retCode = ncGraphCreate("SqueezeNet Graph", &graphHandlePtr);
    if (retCode != NC_OK)
